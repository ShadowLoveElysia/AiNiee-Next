...
DEFAULT_CONFIG = {
    ...
    "dynamic_glossary_switch": False,
    "dynamic_glossary_series": "",
    "dynamic_glossary_volume": None,
    "dynamic_glossary_volume_map": {},
    "character_recall_switch": True,
    "character_recall_context_lines": 50,
    "character_recall_lookahead_lines": 10,
    "character_recall_max_strong": 5,
    ...
    "enable_batch_auto_merge_ebook": False,
    ...
    "platforms": {
        ...
        "deepseek": {
            ...
            "think_depth": "max",
            "auto_complete": True,
            "model_datas": ["deepseek-v4-flash", "deepseek-v4-pro", "deepseek-chat", "deepseek-reasoner"],
            "key_in_settings": [
                "api_key",
                "model",
                "rpm_limit",
